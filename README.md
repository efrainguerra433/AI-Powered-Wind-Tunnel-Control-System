...
This project presents a **pneumatic levitation wind tunnel** controlled in real time using **computer vision and embedded control**. A lightweight ball is levitated inside a **1.4 m acrylic tube**, and its vertical position is regulated by adjusting the airflow generated by a DC motor with a propeller.
...
* **Mechanical Structure:** 1.4 m acrylic tube
